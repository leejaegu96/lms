...
<body onload="fnCateInit();">
		...
		<section id="blog" class="blog">
			<div class="container" data-aos="fade-up">
				<div class="row">
					...
					<div class="col-lg-8">
						<div class="sidebar">
							<h4 style="font-weight:bold;">강의등록</h4><br>
							<div class="row mb-3">
								...
								<div class="col-10">
									<form name="fcate" method="post">
										<div class="row">
											...
											<div class="col-6">
												<span id="cate2"><Select class="form-select" name='cate2'><option style="text-align: center;" value=''>=소분류=</option></select></span>
											</div>
										</div>
									</form>
								</div>
    ...
    function addSChapter() {
        ...
        listHTML += '<button type="button" class="btn btn-primary" onclick="remove(chapterSDelete' + count_SmallChapter + ')">';
    ...
    function addBChapter() {
        ...
        listHTML += '</div>';
        listHTML += '<div class="col-1" style="padding: 0px 0px;">';
        listHTML += '<button type="button" id="btnPlus" class="btn btn-danger" onclick="remove(chapterBDelete' + count_BigChapter + ')">';
        listHTML += '<i class="fa-solid fa-minus"></i>';
        listHTML += '</button>';
        listHTML += '</div>';
        listHTML += '</div>';
	...
	<script>
        ...
        function fnCateInit() {
            ...
            cate1.innerHTML = "<select class='form-select' name='cate1' onchange='fnCate2Chg()'>" + arr1.join() + "</select>";
        }
        ...
        function fnCate2Chg() {
            ...
            if (gap != "") {
                ...
                cate2.innerHTML = "<select class='form-select' name='cate2' >" + arr2.join() + "</select>";
                ...
                cate3.innerHTML = "<select class='form-select' name='cate3'>" + arr3.join() + "</select>";
            } else {
            }
        }
        /* 
