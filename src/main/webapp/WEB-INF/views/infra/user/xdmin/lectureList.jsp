      ...
      ===================================== -->
        ...
        ===================================== -->
										...
										<div class="row gx-3 gy-2">
											...
											<div class="col-3" style="margin-bottom: 10px;">
												<select id="shOption" name="shOption" class="form-control rounded-0" id="exampleFormControlSelect14">
													...
													<option value="3" <c:if test="${vo.shOption eq 3}">selected</c:if>>Category</option>
												</select>
											</div>
											<div class="col-3" style="margin-bottom: 10px;">
											...
											<tbody>
												...
												<c:set var="i" value="${i+1 }" />
													<tr>
														...
														<td>${list.iltSeq }</td>
														<td>${list.ictgItem }/${list.ictsItem }</td>
														<td>${list.iftcName }</td>
														<td>${list.iltTitle }</td>
														<td>${list.iltVideoCount }</td>
														<td>${list.iltPrice }</td>
														<td>${list.iltUseNy }</td>
														<td>
															<div>
																<button type="button" style="font-weight: bold;" class="btn01" onclick="fn_spread('hiddenContent0${i}');">자세히보기</button>
																<div id="hiddenContent0${i}" class="example01" style="display: none;">${list.iltBody }</div>
															</div>
														</td>
													</tr>
												</c:forEach>
			...
			<script type="text/javascript">
                var goUrlList = "/lecture/lectureList";
